...
- [ ] 1.1 Add remote-source settings, SQLAlchemy model, repository, and Alembic migration with tenant/operator/conversation/task/file bindings and safe lifecycle fields
