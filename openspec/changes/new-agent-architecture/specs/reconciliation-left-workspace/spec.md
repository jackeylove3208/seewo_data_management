...
The left workspace SHALL retain separate “新建对话” and “外部数据同步” commands, and both commands SHALL respect backend school-lock state and route eventual task creation through the same supervisor runtime.
